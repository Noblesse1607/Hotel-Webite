...
export async function getAvailableRooms(checkInDate, checkOutDate, roomType) {
	const result = await api.get(
		`/hotel/rooms/available-rooms?checkInDate=${checkInDate}
...
export async function registerUser(registration) {
	try {
		const response = await api.post("/hotel/auth/register-user", registration)
		return response.data
	} catch (error) {
...
export async function loginUser(login) {
	try {
		const response = await api.post("/hotel/auth/login", login)
...
export async function getUserProfile(userId, token) {
	try {
		const response = await api.get(`/hotel/users/profile/${userId}`, {
			headers: getHeader()
		})
		return response.data
	} catch (error) {
...
export async function deleteUser(userId) {
	try {
		const response = await api.delete(`/hotel/users/delete/${userId}`, {
			headers: getHeader()
		})
		return response.data
	} catch (error) {
...
export async function getUser(userId, token) {
	try {
		const response = await api.get(`/hotel/users/${userId}`, {
			headers: getHeader()
		})
		return response.data
	} catch (error) {
...
export async function getBookingsByUserId(userId, token) {
	try {
		const response = await api.get(`/hotel/bookings/user/${userId}/bookings`, {
			headers: getHeader()
		})
		return response.data
	} catch (error) {
